...
export const projects = [
  {
    ...
    "image": whatsapp,
    "description": "A clone of the WhatsApp web app with ability to create account, sending various messages such as texts, stickers, photos and gifs. Create and delete chats, blocking users/contacts,delete messages, clear chat messages, pinning chat, archiving chat, staring messages and some other WhatsApp functionalities. ",
    "techs": [
      "React",
      "SCSS",
      "Material-UI",
...

  {
    ...
    "image": base64,
    "description": "A simple NPM package that helps transform image(s) files to Base64 files. Comes with a custom button to trigger the image selection prompt from the user's device and preferred customized buttons can also be used if the user does not fancy the inbuilt custom button..",
...

  {
    ...
    "image": os_messenger,
    "description": "A simple web chat application, one of my very first fullstack application using firebase, not the best of UI, but it helped in my progress of learning more about React and Fullstack applications. Has functions such as sending messages, and adding users as favourite chat partner.",
    "techs": [
      "React",
      "SCSS",
      "Material-UI",
